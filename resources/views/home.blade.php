...
<div class="main-content">
              ...
              <div class="align-items-center justify-content-between">
                <div class="row ">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                    ...
                    <h2 class="mb-3 font-18">₹ {{$expenseThisMonth}}</h2>
            ...
            <div class="card-statistic-4">
              <div class="align-items-center justify-content-between">
                <div class="row ">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                    <div class="card-content">
                      <h5 class="font-15">This Week</h5>
                      <h2 class="mb-3 font-18">₹{{$expenseThisWeek}}</h2>
            ...
            <div class="card-statistic-4">
              <div class="align-items-center justify-content-between">
                <div class="row ">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                    <div class="card-content">
                      <h5 class="font-15">Total Udhar</h5>
  ...
  <footer class="main-footer">
    <div class="footer-left">
      <a href="templateshub.net">Expense Tracker By Raj Pawar@2023</a></a>
    </div>
